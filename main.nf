...
// include processes
include { KRAKEN; EXTRACT_TAXON_SPECIFIC_INFO; COMBINE_KRAKEN_REPORT_FROM_TAXA } from './modules/processes.nf' addParams(final_params)
...
workflow  {
         ...
         KRAKEN(reads_ch, final_params.database)

         EXTRACT_TAXON_SPECIFIC_INFO(KRAKEN.out.kraken_report_ch, final_params.taxon)
